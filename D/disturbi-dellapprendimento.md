---
lettera: D
titolo: Disturbi dell’apprendimento
fonte: https://www.issalute.it/index.php/la-salute-dalla-a-alla-z-menu/d/disturbi-dell-apprendimento
---
...
I disturbi dell'apprendimento, nel loro significato più ampio, riguardano ilneuro-sviluppo, in altre parole dipendono da un'anomalia dello sviluppo del cervello e possono essere di grado lieve, moderato o grave. Possono essere scoperti e accertati (diagnosticati) nelle fasi iniziali dello sviluppo o solo quando il bambino inizia a parlare e a camminare.
...
disabilità intellettivalivello cognitivo borderlineepilessiaADHD(disturbo da deficit di attenzione e iperattività)autismoad alto funzionamentodisturbi d'ansiaalcuni quadri distimici(depressione cronica di grado lieve)
...
Nel linguaggio comune, quando si parla di disturbi dell'apprendimento ci si riferisce specificatamente alla categoria deiDisturbi Specifici dell’Apprendimento (DSA).Essi differiscono dagli altri, più gravi e non specifici, associati a disabilità intellettiva o ad altri disturbi, anche di origine genetica.
...
In base al tipo di difficoltà specifica che determinano, iDisturbi Specifici dell’Apprendimento (DSA) si dividono in:

dislessia, difficoltà a leggere in maniera accurata e fluida, ovvero correttamente e velocemente, con possibili ripercussioni sulla comprensione del testo scrittodisgrafia e disortografia, difficoltà a scrivere in modo corretto dal punto di vista grafico e ortografico, a scrivere in modo fluido e leggibilediscalculia, difficoltà a memorizzare i numeri e le formule di calcolo matematico
...
IDisturbi Specifici dell’Apprendimento (DSA)possono avere livelli diversi di gravità.
...
malattie della mamma, durante lagravidanzaproblemi alla nascita, che comportano la mancanza di ossigeno al cervello del bambinonuove mutazioni geniche del bambino, che predispongono a sviluppare il disturboereditare geni che fanno aumentare la probabilità di sviluppare il disturbo(disabilità ereditaria dell’apprendimento)malattie del bambino, come lemeningiti, incidenti nella prima infanzia

malattie della mamma, durante lagravidanza
...
malattie del bambino, come lemeningiti, incidenti nella prima infanzia
...
I DSA possono anche presentarsi in associazione ad altre malattie o disturbi meglio definiti quali ad esempio, lasindrome di Downe l’autismo. Il 30% delle persone conepilessiapuò sviluppare un disturbo specifico dell’apprendimento.
...
mantenga nel tempo una grave difficoltà a leggere ma abbia un adattamento psico-sociale ottimomigliori la sua capacità di lettura ma vada incontro a difficoltà di adattamento o a disturbi mentali
...
Istituto Serafico per sordomuti e ciechi. I quaderni del Serafico.I disturbi specifici dell'apprendimento